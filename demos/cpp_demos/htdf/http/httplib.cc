...
void Server::set_error_handler(HandlerWithReturn handler) {
...
void Server::set_pre_routing_handler(HandlerWithReturn handler) {
  pre_routing_handler_ = std::move(handler);
}

void Server::set_post_routing_handler(Handler handler) {
